...
from_dir = "C:/Users/ashaa/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/ashaa/Downloads/Downloaded_Files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
